...
(function(html) {
    ...
    * ------------------------------------------------------ */
    ...
    document.querySelectorAll('.modal-popup__close').forEach(button => {
        button.addEventListener('click', () => {
          button.closest('.modal-popup').setAttribute('hidden', true);
        });
      });
    ...
    document.querySelectorAll('.modal-popup__details').forEach(link => {
        link.addEventListener('click', (event) => {
            // Stop the modal from interfering with navigation
            event.stopPropagation();
        });
    });
